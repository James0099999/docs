...
Seamless Integration is built around a bidirectional flow: your casino calls the iGamingAce API to launch games, and Scorpio Play calls your backend to read and write player balances during gameplay.
...
<Steps>
  <Step title="Creating players">
    Before a player can launch any game, you must link them to the iGamingAce API so the system can identify who is playing. Your existing casino user table is not automatically visible to Scorpio Play — you need to explicitly create the association.
