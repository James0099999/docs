...
<Steps>
  <Step title="Creating players">
    ...
    Once a player is linked, iGamingAce assigns them a unique string called `playerId`. This becomes the player's permanent identifier within your system and can be referenced in all subsequent API calls.
