...
**_No need to add "Balance" at the end of your callback URL; you can get the request body "command" to identify which callback is coming._**

- **URL:** Your configured Callback URL(ex: [**_https://mycallback.com/cb_**](https://mycallback.com/cb))
- **Method:** POST
